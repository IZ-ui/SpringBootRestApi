INSERT INTO Doc (version, code, name) VALUES (0, 21, 'Паспорт гражданина Российской Федерации');
INSERT INTO Doc (version, code, name) VALUES (0, 12, 'Вид на жительство в Российской Федерации');
